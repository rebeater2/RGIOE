...
(cl:defmethod cl:initialize-instance :after ((m <imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navplay-msg:<imu> is deprecated: use navplay-msg:imu instead.")))

(cl:ensure-generic-function 'gpst-val :lambda-list '(m))
(cl:defmethod gpst-val ((m <imu>))
...
(cl:defmethod acce-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navplay-msg:acce-val is deprecated.  Use navplay-msg:acce instead.")
  (acce m))

(cl:ensure-generic-function 'gyro-val :lambda-list '(m))
(cl:defmethod gyro-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navplay-msg:gyro-val is deprecated.  Use navplay-msg:gyro instead.")
  (gyro m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <imu>) istream)
  ...
  (cl:setf (cl:slot-value msg 'acce) (cl:make-array 3))
  (cl:let ((vals (cl:slot-value msg 'acce)))
    (cl:dotimes (i 3)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<imu>)))
  ...
  "08a3930f07de2d670d1b2b4f3b2dd41c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'imu)))
  "Returns md5sum for a message object of type 'imu"
  "08a3930f07de2d670d1b2b4f3b2dd41c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<imu>)))
  ...
  (cl:format cl:nil "float64 gpst~%float64[3] acce~%float64[3] gyro~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'imu)))
  "Returns full string definition for message of type 'imu"
  (cl:format cl:nil "float64 gpst~%float64[3] acce~%float64[3] gyro~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <imu>))
  (cl:+ 0
     8
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'acce) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
